...
const serviceData = [
  {
    ...
    "serviceDescription": "Runs a three-model AI consensus swarm to predict the outcome of any active World Cup match on X Layer.\nProvide a valid matchId from the GoalRush live match feed and an optional clientAddress.",
    "serviceType": "A2MCP",
    "fee": "0.5",
  ...
  },
  {
    ...
    "serviceDescription": "Returns a high-confidence consensus winner for any FIFA World Cup match using a three-agent AI swarm vote. Optional: clientAddress wallet.",
    "serviceType": "A2MCP",
    "fee": "0.5",
    "endpoint": "https://goal-rush-backend-production.up.railway.app/api/predict"
  }
