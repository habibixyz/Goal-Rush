...
const HOOK_ADDRESS         = process.env.HOOK_ADDRESS   || '0xC907030AeCd8fC81B19678cDD08DCF96cD9380c0';
...
const PRE_ACTIVATE_WINDOW  = 5 * 60;   // activate 5 min before kickoff (seconds)
